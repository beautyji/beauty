...
const postsQuery = `*[_type == "post" && references('skincare')]{
  _id,
  title,
  slug,
  mainImage,
...
export default function Products_News_Others ( {posts} )  {
    return(
        <>
        <Head>
        <title>Skincare brand reviews, And which best Skincare for you</title>
      <meta name="description" content="Skincare brand reviews, Skincare tips and trick, Skincare brand history and their best products"/>
        </Head>
        {/*heading area*/}
