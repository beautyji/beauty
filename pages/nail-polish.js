...
const postsQuery = `*[_type == "post" && references('nailpolish')]{
  _id,
  title,
  slug,
  mainImage,
...
export default function Products_News_Others ( {posts} )  {
    return(
        <>
        <Head>
        <title>Nail polish brand reviews, And which best Nail polish for you</title>
      <meta name="description" content="nail polish brand reviews, nail polish tips and trick, nail polish brand history and their best products"/>
        </Head>
        {/*heading area*/}
