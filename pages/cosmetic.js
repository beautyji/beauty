...
const postsQuery = `*[_type == "post" && references('cosmetic')]{
  _id,
  title,
  slug,
  mainImage,
...
export default function Products_News_Others ( {posts} )  {
    return(
        <>
        <Head>
        <title>All cosmetic tips and products categories</title>
      <meta name="description" content="Cosmetic tips, tricks, product reviews, product details, product history category page"/>
        </Head>
        {/*heading area*/}
