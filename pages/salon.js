...
const postsQuery = `*[_type == "post" && references('salon')]{
  _id,
  title,
  slug,
  mainImage,
...
export default function Products_News_Others ( {posts} )  {
    return(
        <>
        <Head>
        <title>Salon brand reviews, And which best Salon for you</title>
      <meta name="description" content="Salon brand reviews, Salon tips and trick, Salon brand history and their best products"/>
        </Head>
        {/*heading area*/}
